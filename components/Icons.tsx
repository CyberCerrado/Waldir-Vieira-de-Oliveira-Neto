...
export const PrinterIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M7 7H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2"></path>
        <path d="M17 7h2a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2h-2"></path>
        <path d="M17 17H7a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2z"></path>
        <path d="M8 12h8"></path>
        <path d="M12 2v5"></path>
        <path d="M7 17v4h10v-4"></path>
    </svg>
);
